    ...
    <div>
        ...
        <form @submit.prevent="() => submit(shop_id)">
            <div class="flex flex-col gap-1">
                <ShopCreateSchedulingItem v-for="(day_of_week, key) in form.scheduling" :key="key" :day="key"
                    :day-of-week-item="form.scheduling[key]" />
            </div>

            <v-btn type="submit" variant="flat" color="primary" class="mt-4 text-white!">Submit</v-btn>
        </form>
    </div>
</template>