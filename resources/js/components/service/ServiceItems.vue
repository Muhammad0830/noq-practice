  ...
  >
    ...
    >
      <div
        ...
        class="flex items-top justify-between gap-4 w-full"
      >
        <div class="space-y-2 flex-1 min-w-0">
          <h5 class="text-lg font-semibold w-full truncate">
            {{ service.name }}
          </h5>
      ...
      <div class="flex items-center gap-4 justify-between">
        <div :class="{ 'opacity-50': !service.is_active }">
          3 Staffs
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <SwitchButton
            :model-value="Boolean(service.is_active)"
