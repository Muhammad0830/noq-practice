...
import { AvailableTimeDataProps, AvailableTimeProps } from '@/types/Scheduling';
...
console.log(timeCards.value)
</script>

<template>
    <div v-if="isShopOpen" class="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 sm:gap-3 gap-2">
        <v-card v-for="timeItem in timeCards"
